...
App link: https://advanced-investment-tool.replit.app
...
Fixed Income: Duration, Convexity, Term Structure
...
Choose your subset of available tickers.

Run the optimizer → view efficient frontier and portfolio stats.

Navigate through the theory sections to review the concepts.

Use the flashcards to test understanding.
